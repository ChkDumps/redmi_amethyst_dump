...
cat vendor_boot/dtb/03_dtbdump_Qualcomm_Technologies,_Inc._Volcano6P_SoC.dtb.* 2>/dev/null >> vendor_boot/dtb/03_dtbdump_Qualcomm_Technologies,_Inc._Volcano6P_SoC.dtb
rm -f vendor_boot/dtb/03_dtbdump_Qualcomm_Technologies,_Inc._Volcano6P_SoC.dtb.* 2>/dev/null
...
cat odm/lib64/libarcsoft_hdr_raw.so.* 2>/dev/null >> odm/lib64/libarcsoft_hdr_raw.so
rm -f odm/lib64/libarcsoft_hdr_raw.so.* 2>/dev/null
cat odm/lib64/libarcsoft_portrait_hdr_raw.so.* 2>/dev/null >> odm/lib64/libarcsoft_portrait_hdr_raw.so
rm -f odm/lib64/libarcsoft_portrait_hdr_raw.so.* 2>/dev/null
...
cat product/app/MiLinkOS3Global/MiLinkOS3Global.apk.* 2>/dev/null >> product/app/MiLinkOS3Global/MiLinkOS3Global.apk
rm -f product/app/MiLinkOS3Global/MiLinkOS3Global.apk.* 2>/dev/null
...
cat mi_ext/product/priv-app/Messages_arm64_xxhdpi/Messages_arm64_xxhdpi.apk.* 2>/dev/null >> mi_ext/product/priv-app/Messages_arm64_xxhdpi/Messages_arm64_xxhdpi.apk
rm -f mi_ext/product/priv-app/Messages_arm64_xxhdpi/Messages_arm64_xxhdpi.apk.* 2>/dev/null
